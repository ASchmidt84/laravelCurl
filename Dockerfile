...
RUN apt-get update && apt-get -y install git curl libcurl3 libcurl3-dev php5-mcrypt php5-json php5-curl && apt-get -y autoremove && apt-get clean && rm -rf /var/lib/apt/lists/*
